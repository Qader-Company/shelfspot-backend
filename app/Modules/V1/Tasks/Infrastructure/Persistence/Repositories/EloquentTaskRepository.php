...
class EloquentTaskRepository implements TaskRepositoryInterface
{
    ...
    public function detailRelations(): array
    {
        return [
            ...
            'services.products.product.brand.translations',
            'services.products.product.subBrand.media',
            'services.products.product.subBrand.translations',
            'services.products.product.category',
            'services.products.product.category.media',
            'services.products.product.category.translations',
            'services.products.product.subCategory',
            'services.products.product.subCategory.media',
            'services.products.product.subCategory.translations',
            'creator',
            'company',
            'assignedWorker.user',
            'currentWorkerAssignment',
