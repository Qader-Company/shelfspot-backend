...
class UpdateCompanyTaskRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'services.*.service_key' => ['required_with:services', 'string', 'distinct', new Enum(ServiceTypeEnum::class)],
            'services.*.service_id' => ['required_with:services', 'integer', 'distinct'],
            'services.*.execution_instructions' => ['nullable', 'string', 'max:5000'],
            'services.*.products' => ['required_with:services', 'array', 'min:1'],
