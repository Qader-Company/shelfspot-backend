    ...
    'catalog' => [
        ServiceTypeEnum::PRIMARY_DISPLAY->value => [
            ...
            'request_form' => [
                'fields' => [
                    ...
                    'planogram_media_ids' => ['type' => 'array<media_id>', 'required' => true, 'min_items' => 1, 'attachment_type' => 'planogram'],
                ],
            ...
            'submission_form' => [
                ...
                'fields' => [
                    'before_picture_media_ids' => ['type' => 'array<media_id>', 'required' => true, 'min_items' => 1, 'attachment_type' => 'before_picture'],
                    'after_picture_media_ids' => ['type' => 'array<media_id>', 'required' => true, 'min_items' => 1, 'attachment_type' => 'after_picture'],
        ...
        ServiceTypeEnum::SECONDARY_DISPLAY_EXECUTION->value => [
            ...
            'request_form' => [
                'fields' => [
                    ...
                    'sub_category_id' => ['type' => 'integer', 'required' => true, 'source' => 'company_sub_categories'],
                    'planogram_media_ids' => ['type' => 'array<media_id>', 'required' => true, 'min_items' => 1, 'attachment_type' => 'planogram'],
                    'job_order_media_ids' => ['type' => 'array<media_id>', 'required' => false, 'min_items' => 1, 'attachment_type' => 'job_order'],
                ],
                'requires_products' => true,
            ],
            'submission_form' => [
        ...
        ServiceTypeEnum::INSTORE_VISIBILITY->value => [
            ...
            'submission_form' => [
                'readonly_job_order_fields' => ['location', 'service_type', 'brand', 'sub_brand', 'category', 'sub_category', 'attachments'],
                'fields' => [
                    'picture_media_ids' => ['type' => 'array<media_id>', 'required' => true, 'min_items' => 1, 'attachment_type' => 'visibility_picture'],
                    'additional_notes' => ['type' => 'string', 'required' => false, 'max' => 2000],
                ],
            ],
        ],
