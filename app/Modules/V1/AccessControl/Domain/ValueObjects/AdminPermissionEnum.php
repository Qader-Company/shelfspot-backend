...
enum AdminPermissionEnum: string
{
    ...
    public function group(): PermissionGroupEnum
    {
        return match ($this) {
            ...
            self::VIEW_COMPANY_USER, self::CREATE_COMPANY_USER, self::EDIT_COMPANY_USER, self::RESET_COMPANY_USER_PASSWORD, self::DELETE_COMPANY_USER => PermissionGroupEnum::COMPANIES,
