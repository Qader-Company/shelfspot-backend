...
class ProductExcelService extends AbstractCatalogExcelService
{
    protected function config(): array
    {
        return [
            ...
            'filename' => 'products',
            'sheet' => 'Products',
            'headings' => ['name_en', 'name_ar', 'brand', 'sub_brand', 'category', 'sub_category', 'sku', 'barcode', 'min_quantity', 'description_en', 'description_ar', 'is_active'],
            'sample' => ['Example Product', 'مثال منتج', null, null, null, null, 'SKU-001', '6221234567890', 1, 'Optional description', 'وصف اختياري', 'yes'],
            'fillable' => ['name_en', 'name_ar', 'brand_id', 'sub_brand_id', 'category_id', 'sub_category_id', 'sku', 'barcode', 'min_quantity', 'description_en', 'description_ar', 'is_active'],
            'defaults' => ['min_quantity' => 1],
            'validation_rules' => ['min_quantity' => ['sometimes', 'integer', 'min:1']],
